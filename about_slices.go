...
func aboutSlices() {
	...
	// It's originally a slice of three elements, you append one, and the cap is double what it was at the start?
	...
	// So you just double the capacity with an append? Weird...
